...
void usage ()
{
  ...
  cout
      ...
      << endl;
  cout << endl;
  cout << endl << "rdfind is written by Paul Dreik 2006. License: GPL v2 or "
                  "later (at your option)." << endl;
